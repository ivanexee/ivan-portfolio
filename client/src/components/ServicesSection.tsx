/* ============================================================
   ...
   - Fully responsive accordion rows
   - Business-focused elevated language, no AI references
   ============================================================ */
  ...
  return (
    ...
    >
      <motion.button
        ...
        style={{ width: "100%", display: "flex", alignItems: "center", gap: "1rem", padding: "1.25rem 0", textAlign: "left", background: "transparent", border: "none", cursor: "pointer" }}
      >
        {/* Number */}
        <span style={{ fontFamily: "JetBrains Mono, monospace", fontSize: "0.6rem", letterSpacing: "0.1em", color: "rgba(13,13,13,0.28)", minWidth: "3rem", flexShrink: 0 }}>
          {service.num}
        </span>

        {/* Title */}
        <motion.span
          animate={{ color: open ? "#00C8E0" : "#0D0D0D" }}
          transition={{ duration: 0.2 }}
          style={{ fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "clamp(0.9rem, 2vw, 1.3rem)", letterSpacing: "-0.02em", flex: 1 }}
        >
          {service.title}
        </motion.span>
        ...
        <span
          ...
          style={{ fontFamily: "DM Sans, sans-serif", fontSize: "0.82rem", color: "rgba(13,13,13,0.35)", fontStyle: "italic", flex: "0 0 auto", maxWidth: "220px", textAlign: "right" }}
        >
          {service.tagline}
        </span>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div className="pb-6" style={{ paddingLeft: "clamp(1rem, 4vw, 5.5rem)", paddingRight: "1rem" }}>
              <p style={{ fontFamily: "DM Sans, sans-serif", fontSize: "clamp(0.88rem, 2vw, 0.95rem)", color: "rgba(13,13,13,0.58)", lineHeight: 1.8, maxWidth: "600px" }}>
                {service.description}
              </p>
              <motion.a
                href="#contact"
    ...
    <section id="services" style={{ background: "#F5F3EE", color: "#0D0D0D" }}>
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 pt-14 pb-8" ref={ref}>
        <motion.h2
          ...
          style={{ fontFamily: "Syne, sans-serif", fontWeight: 800, fontSize: "clamp(1.75rem, 4vw, 3.8rem)", lineHeight: 1.05, letterSpacing: "-0.04em", color: "#0D0D0D", maxWidth: "700px" }}
        >
        ...
        <motion.p
          ...
          style={{ fontFamily: "DM Sans, sans-serif", fontSize: "clamp(0.9rem, 2vw, 1rem)", color: "rgba(13,13,13,0.5)", lineHeight: 1.7, maxWidth: "500px", marginTop: "1.25rem" }}
        >
      ...
      {/* Accordion rows */}
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 pb-16" style={{ borderTop: "1px solid rgba(13,13,13,0.1)" }}>
