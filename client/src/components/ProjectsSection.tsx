/* ============================================================
   ...
   - Light cream background with numbered section header
   - Large editorial heading
   - Full-bleed side-by-side project cards (like Radiance work section)
   - Each card: large image, project name overlay, hover reveal details
   ============================================================ */
...
const projects = [
  {
    ...
    description: "A full multi-page website built for an authentic Mexican taqueria in Queens, NY. Features a digital menu, location info, photo gallery, and mobile-first responsive design that brings the restaurant's warmth online.",
  ...
  },
  {
    ...
    description: "An AI-powered professor rating and mentorship platform built exclusively for Brooklyn College students. Features Gemini AI integration for smart recommendations, student reviews, and a Rate My Professor-style interface.",
    stack: ["React", "TypeScript", "Gemini AI", "Node.js"],
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "linear-gradient(to top, rgba(13,13,13,0.9) 0%, rgba(13,13,13,0.1) 50%, transparent 100%)" }}
      />
    ...
    <section id="projects" style={{ background: "#F5F3EE", color: "#0D0D0D" }}>
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-between py-5 border-b border-black/10">
          ...
          <span className="section-category">(OUR WORK)</span>
        </div>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 pt-16 pb-10" ref={ref}>
        ...
        >
          Every project is a real product built for real users — not just a portfolio piece.
        </motion.p>
      </div>
